...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data"> <!-- Adicionado 'enctype' para permitir o upload de arquivos -->
            @csrf
            <div class="mb-3">
            ...
            <!-- Novo campo para upload da imagem da capa -->
            <div class="mb-3">
